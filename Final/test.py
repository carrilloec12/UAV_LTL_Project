...
env_prog = '!obs3' 
#env_safe = set()
env_safe = { '(obs3->(X count = count+1))','(!obs3->(X count = 0))',' (obs3 -> (X (!obs3)))', '(!obs3 -> (X (obs3)))'}
# @environ_section_end@
#'(countb3 <= 1)',
 #               '((!b9) -> (X countb9 = countb9+1))',
...
# # Environment variables and specification
# # @environ_section@
# env_vars = {'obs3': 'boolean'}  
# env_init = {'!obs3'}    
# env_prog = '!obs3' 
# #env_safe = set()
# env_safe = {'(obs3 -> (X (!obs3)))', '(!obs3 -> (X (obs3)))'}
# # @environ_section_end@
# #
...
# # @environ_section@
# env_vars = {'X1o':'boolean','count': range(2)}
# env_init = {'!X1o', 'count=0'}            
# env_prog = {'X1o'}
# env_safe = {'(X1o) -> X (count=count+1)'}     
