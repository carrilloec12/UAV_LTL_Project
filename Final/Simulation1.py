...
This is my attempt at having two UAVs and one environment system
...
sys.states.add_from(['X0','X1','X2','X3','X4','X5','X6','X7','X8','X9','X10','X11','X12','X13','X14','X15'])
...
# Define the states of the system
sys2.states.add_from(['X0','X1','X2','X3','X4','X5','X6','X7','X8','X9','X10','X11','X12','X13','X14','X15'])
sys2.states.initial.add('X0')    # start in state X0
...
sys2.transitions.add_comb({'X0'}, {'X1','X4'})
sys2.transitions.add_comb({'X1'}, {'X5','X0','X2'})
sys2.transitions.add_comb({'X2'}, {'X6','X1','X3'})
sys2.transitions.add_comb({'X3'}, {'X2','X7'})
sys2.transitions.add_comb({'X4'}, {'X5','X0','X8'})
sys2.transitions.add_comb({'X5'}, {'X1','X6','X4','X9'})
sys2.transitions.add_comb({'X6'}, {'X7','X2','X5','X10'})
sys2.transitions.add_comb({'X7'}, {'X3','X6','X11'})
sys2.transitions.add_comb({'X8'}, {'X12','X4','X9'})
sys2.transitions.add_comb({'X9'}, {'X5','X13','X10','X8'})
sys2.transitions.add_comb({'X10'}, {'X14','X6','X11','X9'})
sys2.transitions.add_comb({'X11'}, {'X15','X7','X10'})
sys2.transitions.add_comb({'X12'}, {'X13','X8'})
sys2.transitions.add_comb({'X13'}, {'X9','X12','X14'})
sys2.transitions.add_comb({'X14'}, {'X10','X13','X15'})
sys2.transitions.add_comb({'X15'}, {'X14','X11'})
...
sys2.states.add('X15', ap={'goal'})
# sys2.states.add('X3', ap={'obs3'})
# sys2.states.add('X6', ap={'obs6'})
# sys2.states.add('X9', ap={'obs9'})
# sys2.states.add('X12', ap={'obs12'})
...
sys_init = set()
sys_prog = set()
sys_safe = set() #{'((obsX3) -> X (!obs3))', '((obsX6) -> X (!obs6))', '((obsX9) -> X (!obs9))', '((obs12) -> X (!obsX12))'}
sys_prog |= {'goal'}
